...
(
	...
	enterprise_application_address varchar(100) NOT NULL COMMENT '申请企业地址',
	enterprise_application_phone varchar(100) NOT NULL COMMENT '申请企业电话',
	enterprise_application_contacts varchar(100) NOT NULL COMMENT '申请企业联系人',
	actual_production_enterprise varchar(64)  COMMENT '实际生产企业',
	actual_production_enterprise_address varchar(64)  COMMENT '实际生产企业地址',
	actual_production_enterprise_phone varchar(64)  COMMENT '实际生产企业电话',
...
(
	...
	administrative_license_inspection  varchar(100)  COMMENT '行政许可检验数据',
	administrative_license_inspection_number  varchar(64)  COMMENT '行政许可检验编号',
	administrative_license_inspection_report_time datetime  COMMENT '行政许可检验取报告时间',
	human_test_acceptance_number  varchar(64)  COMMENT '人体检验受理编号',
	human_test_acceptance_report_time datetime  COMMENT '人体检验取报告时间',
	risk_test_acceptance_number  varchar(64)  COMMENT '风险检验受理编号',
