...
(
	...
	administrative_license_inspection_number  varchar(64)  COMMENT '行政许可检验受理编号',
...
CREATE TABLE mms_policies_regulations (
	...
	file_type char(1) NOT NULL COMMENT '文件分类（1：法规、2：标准、3：技术资料）',
	file_timeliness char(1) COMMENT '文件时效性（1：现行、2：征求意见、3：历史文件）',
	create_by varchar(64) COMMENT '创建者',
	create_date datetime COMMENT '创建时间',
	update_by varchar(64) COMMENT '更新者',
	update_date datetime COMMENT '更新时间',
