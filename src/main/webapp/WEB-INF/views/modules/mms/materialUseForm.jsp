...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mms/materialUse/">原料使用数据库列表</a></li>
		<li class="active"><a href="${ctx}/mms/materialUse/form?id=${materialUse.id}">原料使用数据库<shiro:hasPermission name="mms:materialUse:edit">${not empty materialUse.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="mms:materialUse:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="materialUse" action="${ctx}/mms/materialUse/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">原料序号（导入配方详情的每一项的序号）：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="mms:materialUse:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
