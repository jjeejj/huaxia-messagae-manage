...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mms/enterpriseInformation/">企业信息列表</a></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="enterpriseInformation">
			<tr>
				<td><a href="${ctx}/mms/enterpriseInformation/form?id=${enterpriseInformation.id}">
				...
				<td>
					${fns:getDictLabel(enterpriseInformation.enterpriseType, 'enterprise_type', '')}
				</td>
				<td>
				...
				<td>
					<fmt:formatDate value="${enterpriseInformation.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${enterpriseInformation.remarks}
				</td>
